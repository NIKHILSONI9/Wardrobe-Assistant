...
def main():
    add_bg_from_local('/Users/apple/Desktop/wardrobe/pexels-hngstrm-1939485.jpg')  # Updated background image path
    ...
    sample_image_path = '/Users/apple/Desktop/wardrobe/sample_shirt.png'
    sample_shirt_image = cv2.imread(sample_image_path, cv2.IMREAD_UNCHANGED)

    if sample_shirt_image is None:
        st.error(f"Error loading image at {sample_image_path}.")
        return
